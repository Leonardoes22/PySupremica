...
for i in range(len(inTiles)):
    if(i != 0):
        gr.addTransition("IN","OUT",ga()["in"+coordEnc(outTiles[i][0],outTiles[i][1])])
        gr.setEdgeActions("IN", "OUT", "x="+str(outTiles[i][1])+";y="+str(outTiles[i][0]),i)
        gr.setEdgeActions("IN", "OUT", "x=0;y=0")
